...
class MailsModel:
    ...
    env = Environment(loader=PackageLoader('ingreso.model.templates','.'))
    ...
    def enviar_correo(cls, de, para, asunto, cuerpo):
        ...
        r = requests.post(cls.EMAILS_API_URL + '/correos/', json={'sistema':'ingreso', 'de':de, 'para':para, 'asunto':asunto, 'cuerpo':bcuerpo})
        return r
